...
import ProdukBahanPage from "@/components/produk/produkBahanpage";
  
  async function getDataArticles() {
    let data = [];
    try {
      const ordersRef = collection(db, "produk_bahan");
  ...
  async function AlatLabtool() {
    ...
    return <ProdukBahanPage dataProduk={JSON.parse(JSON.stringify(dataArticle))}/>;
  }
