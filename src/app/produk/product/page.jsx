...
<div className="flex gap-5 pt-2">
                              ...
                              <a href={data.shopee} className="bg-orange-500 p-2 rounded-md text-white"> Link to Shopee</a>
                              <a href={data.tokped} className="bg-green-500 p-2 rounded-md text-white"> Link to Tokopedia</a>
</div>
                              </div>
