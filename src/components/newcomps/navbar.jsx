    ...
    <div className={`relative `}>
        <div className={`w-screen flex flex-col  fixed ${scrollDirection == 'down'? '-translate-y-[88px]':''} duration-300`}>
            ...
            <div className='h-16 bg-white flex justify-between ps-3 pe-20 items-center'>
                ...
                <a className="hover:bg-[#153045] p-2 rounded-md px-3 hover:text-white" href="/">Products</a>
                <a className="hover:bg-[#153045] p-2 rounded-md px-3 hover:text-white" href="/">About</a>
                <a className="hover:bg-[#153045] p-2 rounded-md px-3 hover:text-white" href="/">Contacts</a>
                </div>
            </div>
            <div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M745 0H0V745H1.4873C25.8096 345.514 345.515 25.8091 745 1.4873V0Z" fill="white"/>
</svg>
