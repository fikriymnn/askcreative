      ...
      <div className={`w-screen flex flex-col fixed ${scrollDirection == 'down' ? '-translate-y-[88px]' : ''} duration-300`}>
        ...
        <div className=' h-8 flex justify-center bg-[#123227] text-[7px] p-1 text-white text-center'>
          <p className='flex flex-col'>
            <span>{t('Essential Oil')}</span>
            <span>{t('Health and Beauty')}</span>
          </p>
        </div>
        <div className='flex flex-col'>
          <div className='h-16 bg-white flex justify-between ps-3 pe-20 items-center'>
            <img className="h-12 rounded-md" src="/assets/images/asklogo2.png" alt="" />
            <div className="w-4/6 flex justify-between items-center text-[#123227] text-xl font-bold">
              <a className="hover:bg-[#184737] p-2 rounded-md px-3 hover:text-white" href="/">{t('Beranda')}</a>
              <a className="hover:bg-[#184737] p-2 rounded-md px-3 hover:text-white" href="/events">{t('Kegiatan')}</a>
              <a className="hover:bg-[#184737] p-2 rounded-md px-3 hover:text-white" href="/packages">{t('Layanan')}</a>
              <a className="hover:bg-[#184737] p-2 rounded-md px-3 hover:text-white" href="/articles">{t('Artikel')}</a>
              <a className="hover:bg-[#184737] p-2 rounded-md px-3 hover:text-white" href="/galeri">{t('Galeri')}</a>
              <a className="hover:bg-[#184737] p-2 rounded-md px-3 hover:text-white" href="/about">{t('Tentang')}</a>

              <div className="flex gap-2">
                <button className="border border-slate-300" onClick={() => changeLanguage('id')}>
                  <img
                    src="https://flagcdn.com/h20/id.png"
                    srcSet="https://flagcdn.com/h40/id.png 2x,
                    https://flagcdn.com/h60/id.png 3x"
                ...
                <button className="border border-slate-300" onClick={() => changeLanguage('en')}>
                  <img
                    src="https://flagcdn.com/h20/gb.png"
                    srcSet="https://flagcdn.com/h40/gb.png 2x,
                    https://flagcdn.com/h60/gb.png 3x"
