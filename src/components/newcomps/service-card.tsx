...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-[#184737] border border-transparent  group-hover:border-slate-700 relative z-20 flex flex-col justify-center",
        className
      )}
    >
