            ...
            <div className="p-5 w-full">
              <div className="flex justify-between py-5">
                <a
                  ...
                  href="/dashboardAdmin/catalogue/perfume_aromaterapi/add"
                >
                  <button
                          ...
                          <>
                            <div className="flex bg-slate-300 rounded-md">
                              ...
                              <div className="w-32  flex gap-3 m-3 my-auto">
                                ...
                                href={`/dashboardAdmin/catalogue/perfume_aromaterapi/edit?id=${data.id}`}
                              >
                                <Image
                                  width={35}
                                  height={35}
